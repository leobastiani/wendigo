...
export declare type WendigoSelector = string | DomElement;
...
export declare type WendigoPluginInterface = (...args: Array<any>) => any;
export declare type WendigoPluginAssertionInterface = (...args: Array<any>) => any;
