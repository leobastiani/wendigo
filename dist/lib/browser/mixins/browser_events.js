...
const browser_edit_1 = __importDefault(require("./browser_edit"));
const fail_if_not_loaded_1 = __importDefault(require("../../decorators/fail_if_not_loaded"));
class BrowserEvents extends browser_edit_1.default {
...
], BrowserEvents.prototype, "triggerEvent", null);
exports.default = BrowserEvents;
